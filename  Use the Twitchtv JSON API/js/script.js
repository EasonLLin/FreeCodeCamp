...
*/
  ...
  function logoAndName(logo, name, url) {
      ...
      htmlContent += "<div class='col-xs-2 col-sm-3 channel'><a href='" + url + "'>" + name + "</a></div><div id='" + name.toLowerCase() + "' class='col-xs-7 col-sm-6 col-md-6 col-lg-6 pull-right status'><p class='offline'>offline</p></div></div></div>";
      $('.container').append(htmlContent);
